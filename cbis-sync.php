...
4. Add button to wipe all posts that are created by CBIS sync, i.e. all posts that have custom_field 
   cbis_id set.
5. TODO Also sync 
  * attached images (now URL are synced, not the actual images)
  * ExpirationDate (now article are not synced if ExpirationDate has past)
  * Editor e-mail?
		...
		[Attributes] => stdClass Object ( 
			[AttributeData] => Array ( 
				...
				[3] => stdClass Object ( 
					...
					[MetaType] => String 
					[Value] => stdClass Object ( 
						[Data] => Location: Tveta, south of M�lilla ) 
					[ProductId] => 303753 
					[OrganizationId] => 15774 
					[Version] => 11 
					[Language] => 2 ) 
						...
						[MediaList] => stdClass Object ( 
							[MediaObject] => Array ( 
								[0] => stdClass Object ( 
									...
									[Width] => 4288 
									[Height] => 2848 
									[Description] => Tveta kyrka med metertjocka v�ggar fr�n 1100-talet �r den mest anlitade vigselkyrkan i kontraktet. Tveta kyrka �r formodligen en av de f�rsta kyrkorna i �stra Sm�land. 
									[Keywords] => 
									[ProducedBy] => 
									[CopyrightBy] => 
									[ImageType] => Image ) 
...
function hk_cbis_schedule_activation() {
	...
	if (isset($options['hk_cbis_rss']) && $options['hk_cbis_rss'] != "") {
